...
Si tomamos la matriz $L$ definida como la matriz diagonal que contiene el cociente de los valores propios de $\Lambda$ entre $\Lambda_E$
...
Por otro lado la matriz de cambio de base entre $\mathfrak{B}$ y $\mathfrak{L}$ es $PQ_E^{-1}$ ya que $Q_E$ es la matriz de cambio de base entre $\mathfrak{B}$ y la base canónica
