...
DISCR_COORDS         <- latex_raised_to(DISCR_VECTOR, exp = ITEM_SPACE_BASIS)
ITEM_SPACE_STD_BASIS <- latex_cal("E^*")
DISCR_STD_COORDS    <- latex_raised_to(DISCR_VECTOR, exp = ITEM_SPACE_STD_BASIS)

# Invariance assumption:
DISCR_COORDS_TRANSP         <- latex_transp(DISCR_COORDS)
DISCR_TRAIT_COORDS_PROD     <- latex(DISCR_COORDS_TRANSP, TRAIT_COORDS)
DISCR_STD_COORDS_TRANSP     <- latex_transp(DISCR_STD_COORDS)
DISCR_TRAIT_STD_COORDS_PROD <- latex(DISCR_STD_COORDS_TRANSP, TRAIT_STD_COORDS)
INVARIANCE_EQ               <- latex_eq(
  DISCR_TRAIT_PROD,
  DISCR_TRAIT_COORDS_PROD,
...
DISCR_STD_COORDS_MATRIX_DEF <- latex(
  TRANSFORM_MATRIX,
  INNER_PROD_MATRIX_INV,
  DISCR_COORDS
)
...
# Inner product:
ITEM_SPACE_INNER_PROD <- latex_innerprod(basis = ITEM_SPACE_BASIS)
DISCR_VECTOR_AUX      <- latex_sub(DISCR_VECTOR_ANY, DIM_INDEX)
DISCR_COORDS_AUX    <- latex_raised_to(DISCR_VECTOR_AUX, exp = ITEM_SPACE_BASIS)
