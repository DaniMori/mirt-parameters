...
In an attempt to keep the intended meaning while improving the sentence structure, we have restated it as:
...
After the changes, this paragraph (now in p. 38, l. 19 to p. 39, l. 18) reads:
...
The second change in the discussion consists of stating this explicitly now at the end of the fourth paragraph (previously the fifth one) of the "Discussion" section, in p. 37, ll. 16-18:
...
The second paragraph of this section (p. 16, ll. 18-20) now reads:
...
This choice of labeling is explained in the text in p. 23, ll. 1-8 (see also our response to the last comment below):
...
Subsequently, we have updated ll. 14-15 in p. 15 (now ll. p. 18-19) as follows:
