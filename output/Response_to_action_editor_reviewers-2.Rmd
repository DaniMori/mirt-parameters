...
Finally, the sentence that was found difficult to understand in the abstract (p. 1, ll. 5-7) has been rewritten as follows (p. 1, ll. <!-- # TODO: Complete --> in the current version):
...
The first one corrects ll. <!-- # TODO: Complete --> in p. <!-- # TODO: Complete --> in the previous version, which stated:
...
With this correction applied, these lines now read (p. <!-- # TODO: Complete -->, ll. <!-- # TODO: Complete -->):
...
Subsequently, we have updated ll. <!-- # TODO: Complete --> in p. <!-- # TODO: Complete --> (now p. <!-- # TODO: Complete -->, ll. p. <!-- # TODO: Complete -->) as follows:
