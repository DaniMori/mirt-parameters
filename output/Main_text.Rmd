...
(plot_orth_uncorr_contours + plot_orth_corr) /
  (plot_oblique_ts + plot_oblique_ls) +
  plot_layout(guides = "collect")
## TODO: Review and reformat axis labels

ggsave(file.path(DOC_DIR, "Figure_1.svg"), width = 6.65, height = 5.2)
```
