...
\begin{equation}
  `r DISCR_COORDS_TRANSF_EQ`                  (\#eq:trait-coords-orth-spaces-eq)
\end{equation}
...
any coordinate vector $`r DISCR_COORDS`$ in $`r TEST_SPACE_BASIS`$
can be expressed in
$`r LS_BASIS`$ as $`r DISCR_COORDS_TS_EQ`$, and vice versa.
