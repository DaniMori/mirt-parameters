...
although the agnostic coordinates are the same in both cases,
...
The correlation-based coordinates, plot in panels (c) and (d),
are also different in general from their agnostic counterpart (panel (b)).
This difference is especially salient in the location of items 2 and 3,
...
the item locations and relative positions to the distribution
are correctly represented (allowing a more direct comparison with panel (b)),
but their angles with the axes and discrimination parameters are distorted:
...
items 4 and 5 seem to be equally discriminating,
