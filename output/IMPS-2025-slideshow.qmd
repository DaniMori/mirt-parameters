...
That is why Reckase & McKinley propose to find a way of describing the characteristics of multidimensional items, taking their dimensionality into account.

They do it in this 1985 paper, and a subsequent one in 1991...
:::
...
::: notes
...where they define the item discrimination, which can in turn be used to define the item difficulty.

Note that the difficulty has two components: a "signed distance" from the origin, and a direction.
