...
::: notes
What we actually need is to compute the multidimensional parameters in this general space, which is not necessarily orthogonal (or, we should say more generally, not necessarily orthonormal).
:::
