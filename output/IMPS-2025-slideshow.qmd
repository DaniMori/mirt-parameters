...
The second, that constrain that you see there, implies that the item is represented in an orthogonal basis.
That is the reason why the discrimination is defined by a "general Pythagorean theorem".
:::
