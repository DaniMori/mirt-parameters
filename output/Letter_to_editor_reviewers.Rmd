...
We think the motivation and psychometric utility of our approach are more
related with the interpretation of the item parameters than with the latent
abilities.
To our understanding, the better interpretation of the item parameters that
results from our approach provides indeed a better insight into how the results
are used.
<!-- TODO: Complete -->
...
We have written extensive code in R for computing these parameters, which we intend to open up for public use and scrutiny in a GitHub repository that includes all the code, data, and examples (including all the R packages to re-create the necessary environment to grant computational reproducibility), allowing to generate all the tables, plots, examples, and even the submitted version of the manuscript.
