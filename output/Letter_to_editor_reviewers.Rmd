...
Please refer to our 10th response to Reviewer 3 in p. <!-- TODO: Complete --> of this letter.
...
However, to our understanding, the more precise interpretation of the item parameters that results from our approach provides indeed a better insight into how the results are used.
...
Please see our answer in p. <!-- TODO: Complete (3?) --> of this letter for an example of how the interpretation of the item parameters may change when considering the covariance structure.
<!-- TODO: Complete -->
