...
such as FlexMIRT <!-- TODO: Add reference --> or R package {mirt} [@chalmers_mirt_2012],
...
Using dedicated functions in our code, any interested researcher will be able to compute the multidimensional parameters from the output of any MIRT software (e.g., {mirt} [@chalmers_mirt_2012], FlexMIRT <!-- TODO: Add reference -->).
