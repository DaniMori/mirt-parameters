...
::: notes
Lo mismo pasa al representar los ejes de una rotación oblicua:
Nada me impide representar las coordenadas resultantes en ejes rectangulares (las llamadas "coordenadas Cartesianas rectangulares").
...
::: fragment
> Using orthogonal axes, discrimination corresponds
to the length of the item response vector
