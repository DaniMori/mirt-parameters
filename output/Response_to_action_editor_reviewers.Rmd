...
Given the scale underidentification in IRT, it is relatively common to fix the latent variances to 1, so it is unlikely that non-standard distributions affect these applications.
...
However, in multi-group procedures, such as equating and linking, non-unitary variances (in some of the groups at least) may indeed affect the resulting multidimensional parameters.
