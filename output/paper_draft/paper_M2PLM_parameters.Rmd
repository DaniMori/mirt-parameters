...
Let us consider the model given by Equation \@ref(eq:M2PL-formulation),
...
<!-- # TODO: Discuss; don't think this is actually true -->

We have  $\theta^{'}=P \theta$ so since the probability is invariant,
the parameters $a_i$ must also be transformed in $a^{'}_i$.
