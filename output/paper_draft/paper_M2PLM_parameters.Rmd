...
\end{equation}
<!-- # TODO: I have changed here $D^{-1/2}$ by $D$; discuss with Mario -->
...
\begin{equation}
  `r DIR_COSINE_PROOF_EQ`,                        (\#eq:dir-cosine-proof-prop-1)
\end{equation}
...
the norm of the Euclidean space invariant.

Let $`r DIR_COS_VEC_ALT`$ be the vector of direction cosines of
$`r TRAIT_VECTOR`$ in $`r ALT_BASIS`$ (i.e., the cosines with the elements of
$`r ALT_BASIS`$).
...
<!-- TODO: Comment with Mario (order of terms inverted here) -->
