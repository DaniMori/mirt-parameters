...
abstract: |
  ...
  provides an accurate representation of covariate spaces with correlated
  dimensions and/or non-standard variances. As it is also used in applications
  in the non-cognitive domain, they also need to model negatively-keyeed items
  in an accurate and interpretable manner. Henceforth we generalize the
  ...
  phenomena we intend to measure. Following @ackerman_creating_1994, we also
  provide a geometrical representation based on these parameters, and provide
  applied examples to illustrate the pertinence of these generalized parameters
  to accurately represent the measurement properties of the items.
keywords: |
  Multidimensional IRT, 2-Parameter Logistic model, multidimensional parameters,
  discrimination, difficulty, location, item vector representation
