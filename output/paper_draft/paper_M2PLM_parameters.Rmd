...
accurate on a geometrical coordinate system with non-orthogonal axes and
non-standard units, often referred to as
*general Cartesian coordinates* [@harman_modern_1970].
...
usually reverse-scored--- is also widespread
...
showing that either the original or one of one of the new ones is obtained
