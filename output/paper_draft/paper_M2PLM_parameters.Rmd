...
already assumes the orthogonality of the latent space.
...
```{r compose-empirical-items-table}
```
...
```{r empirical-items-table-out, cache=FALSE, tab.id="empirical-items-table-out", tab.cap="Item parameters for the empirical example"}
item_params_output
```
