...
If we assume that $`r BASIS_EQ`$ or, more generally,
that $`r LS_BASIS`$ is any orthonormal basis, $`r TRANSFORM_MATRIX`$ will be
...
There are three conditions to meet for considering these parameters as
...
Simple arithmetic can show that the first one holds whenever the
...
The covariance-based version $`r MDISC_COV_PARAM`$ does not though,
