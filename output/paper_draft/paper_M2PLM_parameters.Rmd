...
in the test space:
As $`r LS_ORTH_BASIS`$ and $`r TEST_SPACE_STD_BASIS`$ are both
orthonormal in $`r REAL_N_SPACE`$, without loss of generality
we can consider that $`r BASES_EQ`$ (save for a rotation).
We can then map the latent space directly onto the test space and
