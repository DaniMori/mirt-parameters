...
[@ackerman_using_1994; @ackerman_multidimensional_2005; see also @reckase_difficulty_1985, p. 404 and Equation 7].
...
with coordinates $`r TRAIT_VECTOR`$ in $`r LATENT_SPACE`$,
...
the second derivative with respect to $`r TRAIT_MODULE`$.
