...
[see @reckase_difficulty_1985, p. 404 and Equation 7].<!--# It may be worth mentioning that the orthogonality assumption is also implicit in the expression of the M2PL model in polar coordinates (p. 403 and Eq. 3 in Reckase 1985) -->
...
so it does not apply in general to `r DIR_COS_VEC`.<!-- # TODO: To appendix the following, or maybe give for granted? -->
...
also due to the strict positivity of $`r MDISC_PARAM`$,
