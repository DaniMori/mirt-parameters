...
the MIRT literature.
The first one draws from a classical example by @reckase_multidimensional_2009,
...
it can be seen that the $`r MDISC_AG_PARAM`$ and the $`r DISTANCE_AG_PARAM`$
...
In such a case, the covariance-based version of the direction angles
