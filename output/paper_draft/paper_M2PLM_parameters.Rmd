...
the distance will be inversely proportional to the discrimination of the item.
That is, the more discriminating the item is, the further away its location will
be from the origin.
...
This property leads directly to generalizing the parameters to the monotonically
...
$`r CORR_MATRIX`$ for the other two versions of the parameter.
