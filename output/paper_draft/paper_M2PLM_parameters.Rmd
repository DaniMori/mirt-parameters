...
From a geometrical perspective, the item $`r MDISC_PARAM`$ is simply interpreted
...
To do that, we need to chose a version of the parameters
...
Alternatively,
one can compute $`r ORIGIN_ITEM_EQ`$ and $`r END_ITEM_EQ`$ directly from
Equations (\#eq:origin-from-model-params) and (\#eq:end-from-model-params).
