...
However, when such instances appear, they are often
dismissed as “particularly puzzling” (p. 109),
...
complex indicators may have discrimination parameters
with opposite signs for different latent dimensions
[see, e.g. @mclarnon_be_2016, for item parcels with
