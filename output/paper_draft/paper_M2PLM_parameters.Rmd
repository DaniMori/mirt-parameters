...
### Item response function invariance
...
\@ref(eq:eq:M2PL-formulation) induces a bijective relationship between
...
We must make a few remarks here.
...
the alignment of the item vectors with the coordinate axes has a direct,
...
Therefore, an orthonormal basis should represent independent coordinates;
